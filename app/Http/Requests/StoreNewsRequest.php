...
class StoreNewsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'gallery_images' => [
                'nullable',
                'array',
                'max:10' // Máximo 10 imagens na galeria
            ],
            'gallery_images.*' => [
            ...
            'topics' => [
                'nullable',
                'array',
                'max:5' // Máximo 5 tópicos por notícia
            ],
            'topics.*' => [
                'integer',
            ...
            'meta_description' => [
                'nullable',
                'string',
                'max:160' // Limite recomendado para SEO
            ],
            'meta_keywords' => [
                'nullable',
                'string',
    ...
    public function messages(): array
    {
        return [
            ...
            'published_at.after_or_equal' => 'A data de publicação não pode ser no passado.'
        ];
    }
