            ...
            <form action="{{ route('admin.midia-status.update', $midiaStatus->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('description', $midiaStatus->description) }}</textarea>
                </div>

                <button type="submit"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-emerald-600 rounded hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-400">
