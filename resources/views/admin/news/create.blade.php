<x-admin-layout title="Nova Notícia">
    <!-- Header -->
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900">Nova Notícia</h1>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Nova Notícia</span>
                        </div>
                    </li>
                </ol>
            </nav>

            <p class="text-zinc-600 mt-1">Criar um novo artigo para o blog</p>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <textarea id="excerpt"
                              ...
                              rows="3"
                              class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Breve resumo da notícia (opcional)...">{{ old('excerpt') }}</textarea>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="meta_description"
                                      ...
                                      maxlength="160"
                                      class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Descrição para motores de busca (máx. 160 caracteres)">{{ old('meta_description') }}</textarea>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div class="drop-zone border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors" data-type="featured">
                            ...
                            <p class="mt-1 text-sm text-gray-500">JPG, PNG, GIF até 5MB. Mín: 300x200px</p>
                    ...
                    <div class="space-y-4">
                        <div class="drop-zone border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors" data-type="gallery">
                            <input type="file"
                                   ...
                                   multiple
                                   class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            <p class="mt-1 text-sm text-gray-500">Múltiplas imagens, máx 10. JPG, PNG, GIF até 5MB cada</p>
                        ...
                        <div id="gallery-images-preview" class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                            <!-- Gallery previews will be inserted here by JavaScript -->
                        </div>
                    </div>
                </div>
