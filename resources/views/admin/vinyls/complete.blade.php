        ...
        <form action="{{ route('admin.vinyl.storeComplete', $vinylMaster->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50" role="alert">
                ...
                <div class="ml-3 text-sm font-medium">
                    ...
                    <a href="{{ $vinylMaster->discogs_url }}" target='_blank' class="inline-flex items-center px-4 py-2 mt-2 text-sm font-medium text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300">
