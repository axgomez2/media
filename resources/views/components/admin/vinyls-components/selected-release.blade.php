            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                @if(isset($release['brazil_listings']) && is_array($release['brazil_listings']) && count($release['brazil_listings']) > 0)
                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        <div class="flex justify-between items-center mb-2">
                            <h4 class="text-base font-medium text-blue-700">Disponibilidade no Brasil</h4>
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-3">
                            <!-- Preço Baixo Brasil -->
                            <div>
                                <h5 class="text-xs font-medium text-blue-600">Menor Preço</h5>
                            ...
                            <!-- Preço Médio Brasil -->
                            <div>
                                <h5 class="text-xs font-medium text-blue-600">Preço Médio</h5>
                                <p class="text-base font-semibold text-blue-900">
                                    @php
                                        $brMedianPrice = null;
                            ...
                            <!-- Preço Alto Brasil -->
                            <div>
                                <h5 class="text-xs font-medium text-blue-600">Maior Preço</h5>
                                <p class="text-base font-semibold text-blue-900">
                                    @php
                                        $brHighestPrice = null;
